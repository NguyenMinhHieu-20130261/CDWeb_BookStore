                                ...
                                <table className="variations">
                                    ...
                                    <tr>
                                        ...
                                        <td className="value">
                                            ...
                                            </select><a className="reset_variations" href="#">Clear</a>
                                        </td>
                                    </tr>
                                    </tbody>
                                </table>
                        ...
                        <div className="summary__footer px-lg-4 px-xl-7 py-5 d-flex align-items-center">
                            <div
                                ...
                                <div className="yith-wcwl-add-button">
                                    <a href="" rel="nofollow" data-product-id="71" data-product-type="variable"
            ...
            <div className="border-top classic-nav row">
                <ul className="tabs wc-tabs nav container justify-content-md-center flex-nowrap flex-md-wrap overflow-auto overflow-md-visble"
                    ...
                    <li className="description_tab flex-shrink-0 flex-md-shrink-1 nav-item" id="tab-title-description"
                        ...
                        <a href="#tab-description" className="nav-link font-weight-medium py-4">
                            Description </a>
                    </li>
                        ...
                        <div>
                            <div className="mas-static-content">
                                <div className="wp-block-bwgb-product-video bwgb-product-video bwgb-457c7a3"
                                     id="bwgb-457c7a3">
                                    <div className="d-flex mb-8 justify-content-center"><a href="#/"
                        ...
                        <div className="row mb-8 advanced-review-rating">
                            <div className="col-md-12 mb-6">
                                ...
                                <div className="d-md-flex">
                                    <a href="#reviews" className="btn btn-outline-dark rounded-0 px-5 mb-3 mb-md-0"
                                ...
                                <div className="product__inner overflow-hidden p-3 p-md-4d875">
                                    <div className="position-relative d-block">
                                        ...
                                        <div
                                            ...
                                            <a href="?add-to-cart=46" data-quantity="1"
                                            ...
                                            <div
                                                ...
                                                <div className="yith-wcwl-add-button">
                                                    <a href="?add_to_wishlist=46" rel="nofollow" data-product-id="46"
                            ...
                            <div className="bookworm-product-list">
                                <div className="product__inner overflow-hidden p-3 p-md-4d875">
                                    <div className="position-relative d-block">
                                        ...
                                        <div className="col-md-auto d-flex align-items-center"><a href="?add-to-cart=46"
                                                                                                  data-quantity="1"
                                                                                                  className="button product_type_simple add_to_cart_button ajax_add_to_cart text-uppercase text-dark h-dark font-weight-medium mr-auto"
                                                                                                  data-product_id="46"
                            ...
                            <div className="bookworm-product-grid">
                                <div className="product__inner overflow-hidden p-3 p-md-4d875">
                                    <div className="position-relative d-block">
                                        ...
                                        <div
                                            className="woocommerce-loop-product__hover product__hover d-flex align-items-center">
                                            <a href="?add-to-cart=20" data-quantity="1"
                                               className="button product_type_simple add_to_cart_button ajax_add_to_cart text-uppercase text-dark h-dark font-weight-medium mr-auto"
                                            ...
                                            <div
                                                ...
                                                <div className="yith-wcwl-add-button">
                                                    <a href="?add_to_wishlist=20" rel="nofollow" data-product-id="20"
                            ...
                            <div className="bookworm-product-list">
                                <div className="product__inner overflow-hidden p-3 p-md-4d875">
                                    <div className="position-relative d-block">
                                        ...
                                        <div className="col-md-auto d-flex align-items-center"><a href="?add-to-cart=20"
                                                                                                  data-quantity="1"
                                                                                                  className="button product_type_simple add_to_cart_button ajax_add_to_cart text-uppercase text-dark h-dark font-weight-medium mr-auto"
                                                                                                  data-product_id="20"
                            ...
                            <div className="bookworm-product-grid">
                                <div className="product__inner overflow-hidden p-3 p-md-4d875">
                                    <div className="position-relative d-block">
                                        ...
                                        <div
                                            className="woocommerce-loop-product__hover product__hover d-flex align-items-center">
                                            <a href="?add-to-cart=1417" data-quantity="1"
                                               className="button product_type_simple add_to_cart_button ajax_add_to_cart text-uppercase text-dark h-dark font-weight-medium mr-auto"
                                            ...
                                            <div
                                                ...
                                                <div className="yith-wcwl-add-button">
                                                    <a href="?add_to_wishlist=1417" rel="nofollow"
                                ...
                                <div className="product__inner overflow-hidden p-3 p-md-4d875">
                                    <div className="position-relative d-block">
                                        ...
                                        <div className="col-md-auto d-flex align-items-center"><a
                                            href="?add-to-cart=1417" data-quantity="1"
                                            className="button product_type_simple add_to_cart_button ajax_add_to_cart text-uppercase text-dark h-dark font-weight-medium mr-auto"
                                            data-product_id="1417" data-product_sku="BW-1003031-2"
                                            aria-label="Add to cart: &ldquo;The Rural Diaries: Love, Livestock, and Big Life Lessons Down on...&rdquo;"
                                            aria-describedby rel="nofollow" title="Add to cart"><span
                            ...
                            <div className="bookworm-product-grid">
                                <div className="product__inner overflow-hidden p-3 p-md-4d875">
                                    <div className="position-relative d-block">
                                        ...
                                        <div
                                            className="woocommerce-loop-product__hover product__hover d-flex align-items-center">
                                            <a href="?add-to-cart=1161" data-quantity="1"
                                               className="button product_type_simple add_to_cart_button ajax_add_to_cart text-uppercase text-dark h-dark font-weight-medium mr-auto"
                                            ...
                                            <div
                                                ...
                                                <div className="yith-wcwl-add-button">
                                                    <a href="?add_to_wishlist=1161" rel="nofollow"
                            ...
                            <div className="bookworm-product-list">
                                <div className="product__inner overflow-hidden p-3 p-md-4d875">
                                    <div className="position-relative d-block">
                                        ...
                                        <div className="col-md-auto d-flex align-items-center"><a
                                            href="?add-to-cart=1161" data-quantity="1"
                                            className="button product_type_simple add_to_cart_button ajax_add_to_cart text-uppercase text-dark h-dark font-weight-medium mr-auto"
                                            data-product_id="1161" data-product_sku="BW-100303-1"
                                            aria-label="Add to cart: &ldquo;Think Like a Monk: Train Your Mind for Peace and Purpose Everyday&rdquo;"
                                            aria-describedby rel="nofollow" title="Add to cart"><span
                            ...
                            <div className="bookworm-product-grid">
                                <div className="product__inner overflow-hidden p-3 p-md-4d875">
                                    <div className="position-relative d-block">
                                        ...
                                        <div
                                            className="woocommerce-loop-product__hover product__hover d-flex align-items-center">
                                            <a href="?add-to-cart=1413" data-quantity="1"
                                               className="button product_type_simple add_to_cart_button ajax_add_to_cart text-uppercase text-dark h-dark font-weight-medium mr-auto"
                                            ...
                                            <div
                                                ...
                                                <div className="yith-wcwl-add-button">
                                                    <a href="?add_to_wishlist=1413" rel="nofollow"
                            ...
                            <div className="bookworm-product-list">
                                <div className="product__inner overflow-hidden p-3 p-md-4d875">
                                    <div className="position-relative d-block">
                                        ...
                                        <div className="col-md-auto d-flex align-items-center"><a
                                            href="?add-to-cart=1413" data-quantity="1"
                                            className="button product_type_simple add_to_cart_button ajax_add_to_cart text-uppercase text-dark h-dark font-weight-medium mr-auto"
                                            data-product_id="1413" data-product_sku="BW-1003017-1"
                                            aria-label="Add to cart: &ldquo;The Ride of a Lifetime: Lessons Learned from 15 Years as CEO...&rdquo;"
                                            aria-describedby rel="nofollow" title="Add to cart"><span
                                    ...
                                    <div className="position-relative d-block">
                                        ...
                                        <div
                                            ...
                                            <div
                                                ...
                                                <div className="yith-wcwl-add-button">
                                                    <a href="?add_to_wishlist=1162" rel="nofollow"
                            ...
                            <div className="bookworm-product-grid">
                                <div className="product__inner overflow-hidden p-3 p-md-4d875">
                                    <div className="position-relative d-block">
                                        ...
                                        <div
                                            className="woocommerce-loop-product__hover product__hover d-flex align-items-center">
                                            <a href="?add-to-cart=102" data-quantity="1"
                                               className="button product_type_simple add_to_cart_button ajax_add_to_cart text-uppercase text-dark h-dark font-weight-medium mr-auto"
                                            ...
                                            <div
                                                ...
                                                <div className="yith-wcwl-add-button">
                                                    <a href="?add_to_wishlist=102" rel="nofollow" data-product-id="102"
                            ...
                            <div className="bookworm-product-list">
                                <div className="product__inner overflow-hidden p-3 p-md-4d875">
                                    <div className="position-relative d-block">
                                        ...
                                        <div className="col-md-auto d-flex align-items-center"><a
                                            href="?add-to-cart=102" data-quantity="1"
                                            className="button product_type_simple add_to_cart_button ajax_add_to_cart text-uppercase text-dark h-dark font-weight-medium mr-auto"
                                            data-product_id="102" data-product_sku="BW-1003047"
                                            aria-label="Add to cart: &ldquo;The Divorce: A gripping psychological thriller with a fantastic twist&rdquo;"
                                            aria-describedby rel="nofollow" title="Add to cart"><span
                            ...
                            <div className="bookworm-product-grid">
                                <div className="product__inner overflow-hidden p-3 p-md-4d875">
                                    <div className="position-relative d-block">
                                        ...
                                        <div
                                            className="woocommerce-loop-product__hover product__hover d-flex align-items-center">
                                            <a href="?add-to-cart=79" data-quantity="1"
                                               className="button product_type_simple add_to_cart_button ajax_add_to_cart text-uppercase text-dark h-dark font-weight-medium mr-auto"
                                            ...
                                            <div
                                                ...
                                                <div className="yith-wcwl-add-button">
                                                    <a href="?add_to_wishlist=79" rel="nofollow" data-product-id="79"
                            ...
                            <div className="bookworm-product-list">
                                <div className="product__inner overflow-hidden p-3 p-md-4d875">
                                    <div className="position-relative d-block">
                                        ...
                                        <div className="col-md-auto d-flex align-items-center"><a href="?add-to-cart=79"
                                                                                                  data-quantity="1"
                                                                                                  className="button product_type_simple add_to_cart_button ajax_add_to_cart text-uppercase text-dark h-dark font-weight-medium mr-auto"
                                                                                                  data-product_id="79"

...
const FilterComponents = ({priceRange, priceRangeText, isSelected, handlePriceFilterChange}) =>{
    return(
    <li className={`wc-layered-nav-price ${isSelected ? "chosen" : ""}`}>        
        <Link to=""
            onClick={(e) => handlePriceFilterChange(priceRange, e)}
        >
            {priceRangeText}
        </Link>
    </li>
...
const PriceFilter = ({selectedPriceRange, handlePriceFilterChange}) => {
